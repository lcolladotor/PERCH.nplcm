...
#'
#'
#' To do: order the cases and controls according to enrollment date
#'
...
#' @param PathCatDir The directory to the pathogen category specificaton file (.csv)
...
#' @param silent TURE/FALSE. If TRUE, the function will not print anything on the
#' screen. The default is TRUE.
#'
#' @return A list of data. Each element is either a measurement matrix, or a vector
#'  of covariate values
#'
#' @export
#'
extract_data_raw <-
function(Pathogen,Specimen,Test,
         X,Xval,
         MeasDir,PathCatDir,
